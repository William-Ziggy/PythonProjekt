...
GraphicsObjects are provided that can be drawn into a . As a
...
main()
--------------------------------------------------------------------
 objects support coordinate transformation through the
...
#     * Added interactive keyboard input (getKey and checkKey) to
...
#     * Modified the autoflush on  to default to True
...
#       have been closed.
#     Addition of an isClosed method to dow class.

# Version 2.2 8/26/04
#     Fixed cloning bug reported by Joseph Oldham.
#     Now implements deep copy of config info.
# Version 2.1 1/15/04
#     Added autoflush option to . When True (default) updates on
...
#     . All GraphWins are now toplevel windows and share
